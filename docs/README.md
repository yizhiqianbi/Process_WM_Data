...
9. [FastWAM 天机全数据去鱼眼过拟合](training/FASTWAM_TIANJI_DATASET_OVERFIT.md)
...
| [FastWAM Tianji Dataset Overfit](training/FASTWAM_TIANJI_DATASET_OVERFIT.md) | 44 条轨迹、鱼眼到虚拟针孔、跨 episode probe 和 imagination/action demo |
...
- 天机全采集数据去鱼眼训练、probe 和双视频/action 展示只维护在 `training/FASTWAM_TIANJI_DATASET_OVERFIT.md`。
