...
| [old LingBot-VA](LINGBOT_VA.md) | LeRobot v2 | `action_config`、compact-to-30D contract、quantile stats、latent jobs | VAE latent 必须在模型环境继续提取 |
| [DreamZero](DREAMZERO.md) | LeRobot v2 | GEAR modality、stats、relative stats、Hydra patch | 新 embodiment 必须在上游注册 profile |
